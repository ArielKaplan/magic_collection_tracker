...
export const PANELS = [
  ...
  { id: 'top-movers',  title: 'Top Movers',         icon: '📈', component: TopMovers,       defaultSize: { w: 460, h: 320 },
    description: 'Cards whose price has changed the most between the two most recent price snapshots. Gainers are shown in green, losers in red. Requires at least two refresh dates to show movement.' },
